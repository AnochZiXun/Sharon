							...
							<FORM action="{form/@action}" method="POST" enctype="multipart/form-data">
								<FIELDSET>
									...
									<TABLE class="form">
										...
										<TR>
											<TH class="must">
												<LABEL for="merchantId">跨境電商特店代號</LABEL>
											</TH>
											<TD>
												...
												<xsl:if test="not(form/merchantId)or string-length(form/merchantId)='0'">
													<SPAN>&#160;</SPAN>
													<A class="button" href="https://www.allpay.com.tw/" target="_blank">還沒申請跨境電商？請點我！</A>
												</xsl:if>
											</TD>
											<TD>必填。</TD>
										</TR>
										<TR>
											<TH class="must">
												<LABEL for="merchantKey">跨境電商商家加密金鑰</LABEL>
											</TH>
											<TD>
												<INPUT class="monospace" id="merchantKey" name="merchantKey" type="text" value="{form/merchantKey}"/>
											</TD>
											<TD>必填。</TD>
										</TR>
										<TR>
