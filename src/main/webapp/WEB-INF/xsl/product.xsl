...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="document">
		<HEAD>
			...
			<TITLE>旅图中国跨境电商 &#187; <xsl:value-of select="booth/merchandise/name"/></TITLE>
		</HEAD>
		<xsl:comment>
						...
						<NAV>
							...
							<DIV class="cF">
								<ASIDE>
									...
									<A id="aside2" href="/store/{booth/@id}/">店家简介</A>
									<A id="aside3">产品分类</A>
													...
													<xsl:when test="booth/merchandise/images">
														<xsl:for-each select="booth/merchandise/images/*">
															<LI data-thumb="/seventySeven/{@id}.png">
																<IMG alt="产品图片{position()}" src="/threeEightyNine/{@id}.png" width="389" height="389"/>
															</LI>
														</xsl:for-each>
													</xsl:when>
													<xsl:otherwise>
														<LI data-thumb="/IMG/productWithoutImage/77.png">
															<IMG alt="呒产品图片" src="/IMG/productWithoutImage/389.png" width="389" height="389"/>
														</LI>
													</xsl:otherwise>
												</xsl:choose>
											</UL>
												...
												<xsl:for-each select="booth/otherMerchandises/*">
													<DIV>
														<A class="figure" href="/product/{@id}/">
															<FIGURE>
																<IMG alt="产品{position()}" width="195" height="195">
