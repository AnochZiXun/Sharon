										...
										<TABLE class="form">
											...
											<TBODY>
												...
												<TR>
													...
													<TD>
														<INPUT class="monospace" id="email" style="width:100%" maxlength="256" name="email" placeholder="电子邮件" type="text" value="{form/email}"/>
													</TD>
												</TR>
												<TR>
													<TH class="must">
