					...
					<DIV>
						<NAV>
									...
									<xsl:for-each select="banners/*">
										<DIV>
											<xsl:choose>
												...
												<xsl:otherwise>
													<IMG alt="" height="368" src="/banner/{@id}.png" width="980"/>
												</xsl:otherwise>
											</xsl:choose>
										</DIV>
									</xsl:for-each>
							...
							<DIV class="gs" id="topSales">
								<!--4x1x3 = (5+235+5)x4-->
								<DIV>
									<P class="gs" style="margin-left:0;background-color:#FE9903">店家热销</P>
								</DIV>
								<DIV class="owl-carousel">
							...
							<DIV class="gs" id="recommendations">
								<!--8x1 = (5+186+5)-->
								<DIV>
									<P class="gs" style="background-color:#CF232B">推荐商品</P>
								</DIV>
								<UL class="cF">
