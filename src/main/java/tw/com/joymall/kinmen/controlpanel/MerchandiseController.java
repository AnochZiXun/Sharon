...
import tw.com.joymall.kinmen.service.ControlPanelService;
...
public class MerchandiseController {
	...
	private ModelAndView update(@RequestParam("shelf") Long selectedShelfId, @RequestParam String name, @RequestParam Integer price, @RequestParam String html, @RequestParam(defaultValue = "true") Boolean carrying, @RequestParam(defaultValue = "true") Boolean inStock, @RequestParam(defaultValue = "false") Boolean recommend, boolean withItemSId, @RequestParam(required = false) Integer itemWeight, @RequestParam(required = false) String itemModel, @RequestParam(required = false) String itemUnit, @RequestParam(required = false) String itemSId, @PathVariable Long id, HttpServletRequest request, HttpServletResponse response, HttpSession session) throws ParserConfigurationException, SQLException {
		...
		Element elementForm = Utils.createElementWithAttribute("form", documentElement, "action", requestURI);
		elementForm.setAttribute("legend", "修改商品");
		String errorMessage = controlPanelService.saveMerchandise(merchandise, shelfSelected, name, price, html, carrying, recommend, withItemSId, itemWeight, itemModel, itemUnit, itemSId, elementForm);
