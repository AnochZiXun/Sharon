...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="document">
		...
		<P>
			...
			<SPAN>』」的购物；由于交易失败，很抱歉，这笔订单已被取消：</SPAN>
		</P>
		<TABLE style="border-collapse:collapse" border="1" cellspacing="6" cellpadding="6">
			<CAPTION style="text-align:left">
				<P>
					<SPAN>交易编号：</SPAN>
					<SPAN style="font-family:'bitstream vera sans mono',monospace" title="{timestamp}">
			...
			<TFOOT>
				<TR>
					...
					<TD style="font-family:'bitstream vera sans mono',monospace;text-align:right;text-decoration:line-through">
